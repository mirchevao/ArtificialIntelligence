...
test_case = [attr1,attr2,attr3,attr4,planttype]
n = floor(len(trainingData)/2)
tree1 = build_tree(trainingData[:n])
tree2 = build_tree(trainingData[n:])
c1 = classify(test_case,tree1)
c2 = classify(test_case,tree2)
key1 = sorted([*c1.keys()], key = c1.get, reverse = True)
key2 = sorted([*c2.keys()], key = c2.get, reverse = True)
