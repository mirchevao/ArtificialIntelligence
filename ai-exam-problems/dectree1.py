...
index = int(input())
list1 = [x for x in data if x[-1] == 1]
list2 = [x for x in data if x[-1] == 2]
list3 = [x for x in data if x[-1] == 3]
list4 = [x for x in data if x[-1] == 4]
list5 = [x for x in data if x[-1] == 5]
list6 = [x for x in data if x[-1] == 6]
list7 = [x for x in data if x[-1] == 7]

training_set = list1[:5] + list2[:5] + list3[:5] + list4[:5] + list5[:5] + list6[:5] + list7[:5]
tree =  build_tree(training_set)
c = classify(data[index], tree)
keys1 = sorted([*c.keys()], key = c.get, reverse = True)
