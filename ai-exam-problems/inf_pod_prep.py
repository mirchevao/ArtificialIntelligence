...
def isValid(x, y, o1, o2, o3):
    if( x != o1[0] and y != o1[0]) or (x != o1[0] + 1 and y != o1[1]):
        return False
    if ( x != o2[0] and y != o2[1] ) or (x != o2[0] and y != o2[1] + 1) or (x != o2[0] +1 and y != o2[1]) or (x != o2[0] +1 and y != o2[1] +1):
        return False
    if ( x != o3[0] and y != o1[1]) or (x!=o3[0] or y != o3[1] +1):
        return False
    return True
...
pod = PodvizniPrepreki((CoveceRedica, CoveceKolona, (2, 2, -1), (7, 2, -1), (7, 8, 1)),
                                            kuka)

# INFORMIRANO:

answer = astar_search(pod)
