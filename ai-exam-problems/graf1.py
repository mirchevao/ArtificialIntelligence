...
graph_map = UndirectedGraph(dict(
    A=dict(B=dist('A','B')),
    B=dict(C=dist('B','C'), I=dist('B', 'I')),
    C=dict(D=dist('C','D'), F=dist('C','F'), G=dist('C','G')),
    D=dict(L=dist('D','L'), E=dist('D','E')),
...
graph_map.locations = locations
graph_problem=GraphProblem(pocetok, kraj, graph_map)
