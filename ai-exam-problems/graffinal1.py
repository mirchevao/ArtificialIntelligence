...
answer1 = astar_search(graph_problem)
graph_problem = GraphProblem(Stanica1, Kraj, graph)
answer2 = astar_search(graph_problem)
result1 = answer1.solve() + answer2.solve()[1:]
path1 = answer1.path_cost + answer2.path_cost

graph_problem = GraphProblem(Pocetok, Stanica2, graph)
answer3 = astar_search(graph_problem)
graph_problem = GraphProblem(Stanica2, Kraj, graph)
answer4 = astar_search(graph_problem)
result2 = answer3.solve() + answer4.solve()[1:]
path2 = answer3.path_cost + answer4.path_cost
