...
obstacles = [(1,2), (4,2), (7,2), (5,3), (7,3), (2,4), (7,4), (8,4), (3,6), (9,6), (4,7), (6,7), (8,7)]

def move_atom_up(atom1, atom2, atom3):
    while (atom1 not in obstacles) and (atom1 not in [atom2, atom3]) and (0 < atom1[0] < 10 and 0 < atom1[1] < 8):
        x = atom1[0]
        y = atom1 [1]
        y_new = y + 1
        atom_new = x, y_new
...
class Molecule(Problem):
    ...
    def goal_test(self, state):
        ...
        h2_x = state[4]
        h2_y = state[5]
        return h1_x == o_x and o_x == h2_x and h1_y == o_y and o_y == h2_y-1
